...
<head>
    ...
    <title>Proyecto Admón TI2</title>
    ...
    <form action="" method="POST" name="form-login" id="form-login">
            <div class="login slide-up">
                <div class="center">
                    ...
                    <button type="button" class="submit-btn" onclick="ingresar_usuario()">Iniciar</button>
                </div>
            </div>
        </div>
    </form>
